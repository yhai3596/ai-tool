...
export function sourceIdentifierPlugin(options = {}) {
    const { enabled, attributePrefix = 'data-mx', includeProps = true, include = ['.jsx', '.tsx', '.vue'], exclude = [] } = options;
    return {
        ...
        async transform(code, id) {
            ...
            try {
                ...
                // 在转换失败时，记录错误但不中断构建过程
                console.warn(`[vite-plugin-source-identifier] Failed to transform ${id}:`, error);
                return null;
            }
            // 对其他文件不作处理
            return null;
